#ifndef TWOCRUVEPLOT_H
#define TWOCRUVEPLOT_H
...
/**
 * @brief The TwoCruvePlot class
 * 二维曲线图
 */

class TwoCruvePlot : public QWidget , public MsigmaBase
{
    Q_OBJECT

public:
    explicit TwoCruvePlot(QWidget *parent = nullptr,QString classname = "TwoCruvePlot");
    ~TwoCruvePlot();
...
private:
    ...
    std::vector<QAreaSeries *> areaSeries;
    QChartView *chartView = nullptr;

};

#endif // TWOCRUVEPLOT_H
